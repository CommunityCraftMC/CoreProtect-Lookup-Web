...
#   maxCoordinateVolume = maximum x/y/z block volume for coordinate lookups (0 disables)
#   timeoutSeconds  = PHP/database statement timeout hint for lookups (0 disables)
